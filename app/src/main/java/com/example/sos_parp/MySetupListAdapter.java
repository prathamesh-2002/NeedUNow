...
import static com.example.sos_parp.Contact.bg;

public class MySetupListAdapter extends ArrayAdapter<listviewbutton> {
    ...
    public MySetupListAdapter(Context mCtx, int resource, List<listviewbutton> contactList){
